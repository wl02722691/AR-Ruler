...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func calculate() {
        ...
        let xPoint = end.position.x - start.position.x
        let yPoint = end.position.y - start.position.y
        let zPoint = end.position.z - start.position.z
